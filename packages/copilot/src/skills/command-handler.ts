...
interface ParsedCommand {
  ...
  skillName: string;
  /** The remaining arguments after the skill name */
  args: string;
}

/**
 * Result of handling a skill command.
 */
interface HandleResult {
  /** Whether the command was handled */
  handled: boolean;
  /** The modified input with skill content prepended */
  modifiedInput?: string;
  /** Error message if the skill was not found */
  error?: string;
}
