...
describe('SessionRequestHub', () => {
    ...
    it('rejects with timeout error when no response arrives in time', async () => {
        ...
        const timeoutRejection = expect(pendingRequest.waitForResponse).rejects.toBeInstanceOf(SessionRequestTimeoutError);
    ...
    it('cancelSession() rejects all pending promises for that session', async () => {
        ...
        const cancellationRejection1 = expect(pendingRequest1.waitForResponse).rejects.toBeInstanceOf(SessionRequestCancelledError);
        const cancellationRejection2 = expect(pendingRequest2.waitForResponse).rejects.toBeInstanceOf(SessionRequestCancelledError);
    ...
    it('cancelSession() does not affect other sessions', async () => {
        ...
        const cancellationA = expect(pendingA.waitForResponse).rejects.toBeInstanceOf(SessionRequestCancelledError);
