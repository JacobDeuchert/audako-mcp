import { DataConnectionOpcUaSecurityAuthentication, DataConnectionOpcUaSecurityMode, DataConnectionOpcUaSecurityPolicy, DataConnectionOpcUaStringEncoding, } from 'audako-core';
import { registerType } from '../../../services/type-registry.js';
const securityPolicyEnumValues = Object.values(DataConnectionOpcUaSecurityPolicy).filter(value => typeof value === 'string');
const securityModeEnumValues = Object.values(DataConnectionOpcUaSecurityMode).filter(value => typeof value === 'string');
const securityAuthenticationEnumValues = Object.values(DataConnectionOpcUaSecurityAuthentication).filter(value => typeof value === 'string');
const stringEncodingEnumValues = Object.values(DataConnectionOpcUaStringEncoding).filter(value => typeof value === 'string');
const opcUaFields = [
    {
        key: 'url',
        type: 'string',
...
export const DataConnectionOpcUaSettings = {
...
//# sourceMappingURL=opcua.settings.js.map