...
export interface HubRequestSessionEvent<TPayload = unknown>
  extends SessionEventEnvelope<HubRequestPayload<TPayload>> {
  type: 'hub.request';
}
...
export interface QuestionAskHubRequestEvent
  extends SessionEventEnvelope<QuestionAskHubRequestPayload> {
  type: 'hub.request';
}
